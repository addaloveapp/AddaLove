...
const PickerSpinner = () => (
    <div className="flex h-[400px] w-full items-center justify-center rounded-lg bg-zinc-900 shadow-xl">
            ...
            <AnimatePresence>
                {showPicker && (
                    <motion.div
                        ...
                        className="fixed bottom-20 left-1/2 z-50 w-[min(320px,calc(100vw-24px))] -translate-x-1/2 origin-bottom"
                    >
