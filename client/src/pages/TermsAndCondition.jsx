...
const TermsAndConditions = () => {
    ...
    return (
        <div className="min-h-screen bg-[#070514] text-gray-300 font-sans selection:bg-pink-500/30">
            ...
            <div className="max-w-7xl mx-auto mt-5 px-6 py-14 flex flex-col lg:flex-row gap-12">
                <div>
                        ...
                        <nav className="space-y-1">
                            {sections.map((section) => (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm transition-all duration-200 text-left ${activeSection === section.id
